...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                DownloadNewsSearch newsTask1 = new DownloadNewsSearch(query);
                newsTask1.execute();
                return false;
            }
    ...
    class DownloadNewsSearch extends AsyncTask<String, Void, String> {

        public  String queryVar;

        DownloadNewsSearch(String queryVar)
        {
        ...
        protected String doInBackground(String... args) {
            String xml = Function.excuteGet("https://newsapi.org/v2/everything?q="+queryVar+"&apiKey=a18d5ac0411d40bc8310b8cf366116a4");
            return xml;
        }
